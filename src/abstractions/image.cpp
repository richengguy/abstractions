...
PixelData::PixelData(const BLImageData &surface) : _surface{surface} { }
...
Image::Image(const BLImage &buffer) : _buffer{buffer}
{

}

int Image::Width() const { return _buffer.width(); }

int Image::Height() const { return _buffer.height(); }

int Image::Depth() const { return _buffer.depth(); }
